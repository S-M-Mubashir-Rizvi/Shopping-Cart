    ...
    def confirm_login(self, choice):              # Have to pass login choice here
        ...
        if confirmation.lower() == "y":
            ...
            if flag != 0:
                ...
                print("Do you want to re-enter your email or password or both?(Y/N) ", end = "")
                choice_ip = input()
...
class Order:
        ...
        def confirm_order(self):
            ...
            if confirmation.lower() == 'y':
                ...
                shipping_time = self.placement_time + (86400 * 1)
                delievery_time = self.placement_time + (86400 * 2)
...
class ShoppingCart:
    ...
    def show_cart(self):
        ...
        results = self.get_current_user_cart()
       # with Customer.customers_history:
         #   ShoppingCart.s.execute("SELECT * FROM Customer_cart WHERE Customer_email = :email", {'email': self.current_userEmail})
        ...
        print(f"Your cart number is: {cart_no}")
...
while True:
    ...
    if choice == 1:
        ...
        if login_choice == 1:
            ...
            if Main.L.confirm_login(login_choice) == True:
                A = Admin()
            else:
                continue
